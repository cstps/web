                        ...
                        <?php } else { ?>
                            ...
                            <div style="margin-top:8px;">
                                ...
                                <strong>
                                    #<?php
                                        echo intval(
                                            $source_diff['previous_solution_id']
                                        );
                                        ?>
                                </strong>
            ...
            <div class="ui segment">
                ...
                <form
                    ...
                    <input
                        type="hidden"
                        name="course_id"
                        value="<?php echo intval($process_course_id); ?>">
    ...
    <script>
        document.addEventListener(
            ...
            function() {
                ...
                for (
                    var i = 0; i < hiddenInputs.length; i++
                ) {
                    ...
                    for (
                        var j = 0; j < actionForms.length; j++
                    ) {
